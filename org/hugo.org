    ...
    <div class="ten wide column">
      <div class="ui basic segment grid two columns">
        ...
        <div class="column twelve wide">
	      ...
	      <a class = "orange ui small button" href="https://drive.google.com/file/d/1sVOlp3KMBf-3FNAY7VfAfDDjz_960hew/view?usp=sharing" target="_blank">
      ...
      <div class="ui basic segment grid two columns">
        ...
        <div class="column twelve wide">
	      ...
	      <a class = "orange ui small center aligned button" href="https://drive.google.com/file/d/1xzYRRLhhZryLLA3ye3iGq0nhdJt3F8zZ/view?usp=sharing" target="_blank">
            Скачать <i class="ui icon small arrow circle right"></i>
          </a>
          <br>
          <br>
  ...
  <div class="ui grid container two columns stackable mobile reversed">
    <div class="ui column middle aligned">
      <div class="ui segment basic justified">
        ...
        <div class="ui segment basic center aligned">
          <a class="ui button violet centered" target="_blank" href="https://drive.google.com/file/d/1CUYOJNNcc52kJ8Q474mOgLI-pWB96i4G/view?usp=sharing">Скачать инструкцию</a>
          <a class="ui request button orange centered">Запросить информацию</a>
        </div>
        <div class="ui segment basic">
          <div class="ui sub header">
...
<div class="ui vertical segment" id="book-model">
  <div class="ui grid container equal width stackable">
    ...
    <div class="column middle aligned">
      ...
      <a class="ui request button orange" data-href="https://drive.google.com/file/d/1sVOlp3KMBf-3FNAY7VfAfDDjz_960hew/view?usp=sharing" target="_blank" onclick="currentEl=this.getAttribute('data-href');">Скачать</a>
      <p>
...
<div class="ui vertical segment" id="book-agro">
  <div class="ui grid container equal width stackable">
    ...
    <div class="column middle aligned">
      ...
      <a class="ui request button orange" data-href="https://drive.google.com/file/d/1xzYRRLhhZryLLA3ye3iGq0nhdJt3F8zZ/view?usp=sharing" target="_blank" onclick="currentEl=this.getAttribute('data-href');">Скачать</a>
      <p>
  ...
  <div class="ui stackable grid container two columns">
    ...
    <div class="column">
      <div class="ui segment basic">
        ...
        <a target="_blank" href="https://drive.google.com/file/d/1rh6Cf_oU9DD_vo26WFgsC9iTlw_XF3Ct/view?usp=sharing" class="ui button orange">Скачать</a>
        <br>
        <br>
        <p class="ui text">
  ...
  <div class="ui stackable grid container two columns">
    ...
    <div class="column">
      <div class="ui segment basic">
        ...
        <a target="_blank" href="https://drive.google.com/file/d/1NExC2uOnvHugvoNmhWA0l3ATBaWcxDnC/view?usp=sharing" class="ui button orange">Скачать</a>
        <br>
        <br>
        <p class="ui text">
  ...
  <div class="ui stackable grid container two columns">
    ...
    <div class="column">
      <div class="ui segment basic">
        ...
        <a target="_blank" href="https://drive.google.com/file/d/1SQGxUSyilobJ0PdktZWB_2j2FKMY5Pgv/view?usp=sharing" class="ui button orange">Скачать</a>
        <br>
        <br>
        <p class="ui text">
  ...
  <div class="ui stackable grid container two columns">
    ...
    <div class="column">
      <div class="ui segment basic">
        ...
        <a target="_blank" href="https://drive.google.com/file/d/1CEnqPXxZldX_G5E8eDiEl2Cve-hnPCjv/view?usp=sharing" class="ui button orange">Скачать</a>
        <br>
        <br>
        <p>
  ...
  <div class="ui stackable grid container two columns">
    ...
    <div class="column">
      <div class="ui segment basic">
        ...
        <a target="_blank" href="https://drive.google.com/file/d/1Ku0XOvozAWedPtlzafuyfbI3wKYLE_lM/view?usp=sharing" class="ui button orange">Скачать</a>
        <br>
        <br>
        <p>
  ...
  <div class="ui stackable grid container two columns">
    ...
    <div class="column">
      <div class="ui segment basic">
        ...
        <a target="_blank" href="https://drive.google.com/file/d/16g_GSpKaQvk-LHVCm5FZ24s_6e-lKOyO/view?usp=sharing" class="ui button orange">Скачать</a>
        <br>
        <br>
        <p>
